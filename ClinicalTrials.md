...
maintainer: Ya Wang, Elias Laurin Meyer, Laura Pascasio Harris, Orla Doyle, Thomas Jaki, Wilmar Igl
...
-   `r pkg("MAMS")` Designing multi-arm multi-stage studies with (asymptotically) normal endpoints and known variance.
...
-   `r pkg("CRM")` Continual Reassessment Method (CRM) simulator for Phase I Clinical Trials.
...
-   `r pkg("SEARS")` A seamless design that combines phase I dose escalation based on toxicity with phase II dose expansion and dose comparison based on efficacy. 
