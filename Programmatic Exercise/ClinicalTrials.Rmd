...
```{r setup, echo = FALSE}
pkg_desc <- list(
  multcomp = "Provides simultaneous tests and confidence intervals for general linear hypotheses in parametric models, including linear, GLM, mixed-effects, and survival models."
  # …more entries…
)
```
...
-   `​r pkg("multcomp")` `r pkg_desc$multcomp`
